 ...
 * @generated */
public class QuestionActual extends QuestionAnno {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(QuestionActual.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected QuestionActual() {/* intentionally empty block */}
   ...
   */
  public QuestionActual(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public QuestionActual(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public QuestionActual(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
