 ...
 * @generated */
public class QuestionThreeGrams_Type extends QuestionAnnoTokenized_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (QuestionThreeGrams_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = QuestionThreeGrams_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new QuestionThreeGrams(addr, QuestionThreeGrams_Type.this);
  			   QuestionThreeGrams_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new QuestionThreeGrams(addr, QuestionThreeGrams_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = QuestionThreeGrams.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("QuestionThreeGrams");
  ...
  public int getStringArray(int addr) {
      ...
      jcas.throwFeatMissing("StringArray", "QuestionThreeGrams");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public QuestionThreeGrams_Type(JCas jcas, Type casType) {
    super(jcas, casType);
