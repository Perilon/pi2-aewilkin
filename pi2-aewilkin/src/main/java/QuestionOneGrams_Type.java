 ...
 * @generated */
public class QuestionOneGrams_Type extends QuestionAnnoTokenized_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (QuestionOneGrams_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = QuestionOneGrams_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new QuestionOneGrams(addr, QuestionOneGrams_Type.this);
  			   QuestionOneGrams_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new QuestionOneGrams(addr, QuestionOneGrams_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = QuestionOneGrams.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("QuestionOneGrams");
  ...
  public int getStringArray(int addr) {
      ...
      jcas.throwFeatMissing("StringArray", "QuestionOneGrams");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public QuestionOneGrams_Type(JCas jcas, Type casType) {
    super(jcas, casType);
