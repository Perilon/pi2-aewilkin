 ...
 * @generated */
public class AnswerTwoGrams_Type extends AnswerAnnoTokenized_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (AnswerTwoGrams_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = AnswerTwoGrams_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new AnswerTwoGrams(addr, AnswerTwoGrams_Type.this);
  			   AnswerTwoGrams_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new AnswerTwoGrams(addr, AnswerTwoGrams_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = AnswerTwoGrams.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("AnswerTwoGrams");
  ...
  public int getStringArray(int addr) {
      ...
      jcas.throwFeatMissing("StringArray", "AnswerTwoGrams");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public AnswerTwoGrams_Type(JCas jcas, Type casType) {
    super(jcas, casType);
