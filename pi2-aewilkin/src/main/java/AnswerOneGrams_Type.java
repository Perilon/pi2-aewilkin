 ...
 * @generated */
public class AnswerOneGrams_Type extends AnswerAnnoTokenized_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (AnswerOneGrams_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = AnswerOneGrams_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new AnswerOneGrams(addr, AnswerOneGrams_Type.this);
  			   AnswerOneGrams_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new AnswerOneGrams(addr, AnswerOneGrams_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = AnswerOneGrams.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("AnswerOneGrams");
  ...
  public int getStringArray(int addr) {
      ...
      jcas.throwFeatMissing("StringArray", "AnswerOneGrams");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public AnswerOneGrams_Type(JCas jcas, Type casType) {
    super(jcas, casType);
