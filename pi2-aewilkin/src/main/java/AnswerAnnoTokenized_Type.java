 ...
 * @generated */
public class AnswerAnnoTokenized_Type extends AnswerAnno_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (AnswerAnnoTokenized_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = AnswerAnnoTokenized_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new AnswerAnnoTokenized(addr, AnswerAnnoTokenized_Type.this);
  			   AnswerAnnoTokenized_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new AnswerAnnoTokenized(addr, AnswerAnnoTokenized_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = AnswerAnnoTokenized.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("AnswerAnnoTokenized");
  ...
  public int getStringArray(int addr) {
      ...
      jcas.throwFeatMissing("StringArray", "AnswerAnnoTokenized");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public AnswerAnnoTokenized_Type(JCas jcas, Type casType) {
    super(jcas, casType);
